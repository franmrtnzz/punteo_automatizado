...
3. Ejecuta el instalador
 ...
 > **MUY IMPORTANTE:** marca esta casilla antes de instalar:
 >
 > **Add Python to PATH**
...
**Solución:** Reinstala Python y asegúrate de marcar ** Add Python to PATH** durante la instalación.
